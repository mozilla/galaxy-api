...
const ORIGIN = process.env.ORIGIN || settings_local.ORIGIN || settings.ORIGIN;
const PERSONA_VERIFICATION_URL = (process.env.PERSONA_VERIFICATION_URL ||
                                  settings_local.PERSONA_VERIFICATION_URL ||
                                  settings.PERSONA_VERIFICATION_URL);
...
function verifyPersonaAssertion(assertion, audience, callback) {
    ...
    */
    console.log({
        assertion: assertion,
        audience: settings_local.DEBUG ? audience : ORIGIN
    });
