 ...
 * Sample usage:
    promiseMap({
        firstTask: firstTaskPromise(),
        secondTask: secondTaskPromise(),
        lastTask: lastTaskPromise()
    }).then(function(resultMap) {
       var firstTaskResult = resultMap.firstTask;
       var secondTaskResult = resultMap.secondTask;
